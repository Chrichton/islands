defmodule IslandsEngine.Island do
  ...
  @derive {Jason.Encoder, only: [:coordinates, :hit_coordinates]}
  ...
  # Given offsets(:type), iterate and add the coordinate
  ...
  # Add a coordinate with an offset, check if it's valid
